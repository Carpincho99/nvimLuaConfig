...
local mappings = {
  ...
  l = {
    ...
    -- t = { "<cmd>lua require('lsp_lines').toggle() <bar><cr> ", "Toogle lsp_lines" },
  },
  s = {
    name = "Search",
    b = { "<cmd>Telescope git_branches<cr>", "Checkout branch" },
  ...
  --   o = { "<cmd>w <bar> split <bar> terminal gcc -Wall -std=c99 -pedantic-errors % -lm && ./a.out <CR>", "hSplit" },
  --   f = { "<cmd>w <bar> terminal clear && gcc -Wall -std=c99 -pedantic-errors % -lm && ./a.out <CR>", "Float" },
  -- },
  --
